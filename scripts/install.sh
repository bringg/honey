#!/bin/sh
set -e
# Code generated by godownloader on 2020-07-23T13:45:02Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for Shareed2k/honey

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/Shareed2k/honey/releases
